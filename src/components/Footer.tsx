        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-slate-600">
              ...
              <li><Link href="#" className="hover:text-action transition">Changelog</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-slate-600">
              ...
              <li><Link href="#" className="hover:text-action transition">Careers</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-slate-600">
              <li><Link href="#" className="hover:text-action transition">Privacy Policy</Link></li>
              <li><Link href="#" className="hover:text-action transition">Terms of Service</Link></li>
              <li><Link href="#" className="hover:text-action transition">Cookie Policy</Link></li>
            </ul>
          </div>
        </div>

        <div className="pt-8 border-t border-slate-200 text-center text-sm text-slate-400">
          <p>&copy; {new Date().getFullYear()} GlowSeller Inc. All rights reserved.</p>
        </div>
      </Container>
    </footer>
  );
